            ...
            <tbody>
                <?php foreach ($registros as $registro) : ?>
                    <tr>
                        ...
                        <td><?= h($registro->categoria) ?></td>
                        <td><?= h($registro->sucursal) ?></td>
                        <td class="actions">
                            <!-- <?= $this->Html->link(__('View'), ['action' => 'view', $registro->id]) ?> -->
                            <!-- <?= $this->Html->link(__('Download PDF'), ['action' => 'exportPdf', $registro->id]) ?> -->
                            <?php if ($registro->id_estado == 2) : ?>
                                <?= $this->Html->link(__('Descargar PDF'), ['action' => 'exportPdf', $registro->id], ['class' => 'btn btn-success']) ?>
                            <?php endif; ?>
